...
//   image: "/images/services/pcb-assembly.jpg",
// };

// const procurementContent = {
//   title: "Component procurement",
//   description: `For gaining an advantage over your competition, nothing beats a quick turnaround for your PCB assembly services. Flashline PCB is a one-stop shop for all of your PCB fabrication and assembly needs. We will work directly with you to achieve the best quality and the shortest turn around, whether you need low-volume or high-volume PCB assembly. We are the renowned leader in PCB assembly, for our customers using the most up-to-date equipment for PCB assembly. Our electronic PCB assembly services go above and beyond what you expect from a typical PCB assembly firm.`,
//   image: "/images/services/component-procurement.jpg",
// };
...
//       <section className="bg-white pt-20 pb-20 lg:pt-24 lg:pb-28 mt-32">
...
//               <div className="relative h-[340px] w-full overflow-hidden rounded-[18px] bg-slate-100 lg:h-[390px]">

// <Image
//   src="/componentprocurementimage.png"
//   alt="Component procurement"
//   fill
//   className="object-cover"
// />
...
//                   className="h-12 w-full rounded-lg border border-slate-200 px-4 text-sm text-slate-900 outline-none transition focus:border-[#062D82] focus:ring-2 focus:ring-[#062D82]/10"
//                 />
//               </div>
...
//                   className="w-full resize-none rounded-lg border border-slate-200 px-4 py-3 text-sm text-slate-900 outline-none transition focus:border-[#062D82] focus:ring-2 focus:ring-[#062D82]/10"
//                 />
...
//               <button
//                 type="submit"
//                 className="inline-flex items-center gap-3 bg-[#F4511E] px-7 py-3.5 text-sm font-bold uppercase text-white transition hover:bg-[#062D82]"
//               >
//                 Submit
