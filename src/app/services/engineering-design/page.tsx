...
//   const activeContent =
//     engineeringTabs.find((item) => item.id === activeTab) ??
//     engineeringTabs[0];

//   return (
//     <main className="overflow-hidden bg-white mt-36">
...
//         <div className="absolute -left-40 top-0 h-[420px] w-[420px] rounded-full bg-[#1597E5]/10 blur-[130px]" />

//         <div className="absolute -right-40 bottom-0 h-[420px] w-[420px] rounded-full bg-[#F4511E]/10 blur-[130px]" />

//         <div className="container-flashline relative">

//           <div className="grid min-h-[470px] items-center gap-12 py-20 lg:grid-cols-[1fr_0.85fr] lg:py-24">

//             {/* Hero content */}
//             <div>

//               <div className="inline-flex items-center gap-3 border border-[#1597E5]/30 bg-[#1597E5]/10 px-4 py-2 text-xs font-bold uppercase tracking-[0.2em] text-[#7dccff]">

//                 <span className="h-2 w-2 rounded-full bg-[#F4511E] shadow-[0_0_15px_#F4511E]" />

//                 Engineering Services

//               </div>

//               <h1 className="mt-7 max-w-4xl text-5xl font-black leading-[0.98] tracking-[-0.05em] sm:text-6xl lg:text-7xl">
...
//                 <span className="h-[3px] w-9 bg-[#F4511E]" />
//                 <span className="h-[3px] w-5 bg-[#F4511E]/60" />
//                 <span className="h-[3px] w-8 bg-[#1597E5]" />
//                 <span className="h-[3px] w-3 bg-[#1597E5]/60" />
//               </div>

//               <p className="mt-7 max-w-2xl text-base leading-8 text-slate-300 sm:text-lg">
//                 At Flashline EMS, We collaborate with our clients to
//                 develope unique solutions.
//               </p>
...
//                 }}
//                 className="group mt-8 inline-flex items-center gap-3 bg-[#F4511E] px-6 py-4 text-sm font-bold text-white shadow-[0_12px_30px_rgba(244,81,30,0.2)] transition duration-300 hover:-translate-y-1 hover:bg-[#ff6428]"
//               >
//                 Talk to our team
...
//               <div className="absolute -left-5 -top-5 h-28 w-28 border-l-2 border-t-2 border-[#F4511E]" />

//               <div className="absolute -bottom-5 -right-5 h-28 w-28 border-b-2 border-r-2 border-[#1597E5]" />
...
//                 <div className="absolute inset-0 bg-gradient-to-t from-[#06142f]/70 via-transparent to-transparent" />

//                 <div className="absolute bottom-5 left-5 right-5">

//                   <div className="text-[10px] font-bold uppercase tracking-[0.2em] text-[#7dccff]">
//                     Flashline EMS
//                   </div>
...
//         <div className="absolute right-0 top-0 h-[400px] w-[400px] rounded-full bg-[#1597E5]/5 blur-[120px]" />
...
//               <div className="flex items-center gap-3 text-xs font-black uppercase tracking-[0.22em] text-[#F4511E]">
...
//               <h2 className="mt-5 max-w-xl text-4xl font-black leading-tight tracking-[-0.04em] text-[#062D82] sm:text-5xl">
...
//                 with our clients to develop unique solutions.
...
//                 Design collaboration with consumers is crucial to maximize
//                 productivity and apply cost-effective techniques to product
//                 development and solution implementation.
//               </p>

//               <p className="mt-6 text-lg leading-8 text-slate-600">
//                 And the use of collaborative product design guarantees that
//                 industry best practices are followed. Our engineering design
//                 services produce high-quality products and solutions that
//                 foster long-term, mutually benefit.
//               </p>
...
//                   <div
//                     key={item}
//                     className="flex items-center gap-2 border border-slate-200 bg-slate-50 px-4 py-3 text-sm font-bold text-[#062D82]"
//                   >
//                     <CheckCircle2
//                       size={16}
...
//             <div className="text-xs font-black uppercase tracking-[0.22em] text-[#F4511E]">
//               Our Engineering Capabilities
//             </div>

//             <h2 className="mt-4 text-4xl font-black tracking-[-0.04em] text-[#062D82] sm:text-5xl">
...
//               TABS
//           ====================================================== */}
//           <div className="mt-12 overflow-hidden border border-slate-200 bg-white shadow-[0_20px_60px_rgba(6,45,130,0.07)]">
...
//                       ${
//                         isActive
//                           ? "bg-[#062D82] text-white"
//                           : "bg-white text-[#062D82] hover:bg-slate-50"
//                       }
//                     `}
//                   >
...
//                 <div className="flex items-center gap-3 text-xs font-black uppercase tracking-[0.2em] text-[#F4511E]">

//                   <span className="h-[2px] w-8 bg-[#F4511E]" />

//                   {activeContent.label}

//                 </div>

//                 <h3 className="mt-6 max-w-xl text-3xl font-black leading-tight tracking-[-0.035em] text-[#062D82] sm:text-4xl">
...
//                   <div className="flex h-10 w-10 items-center justify-center rounded-full bg-[#F4511E]/10">
//                     <CheckCircle2
//                       size={19}
//                       className="text-[#F4511E]"
//                     />
...
//                   <span className="text-sm font-bold text-[#062D82]">
...
//               {/* Image */}
//               <div className="order-1 min-h-[320px] bg-[#06142f] lg:order-2 lg:min-h-full">
...
//   src={activeContent.image}
//   alt={activeContent.imageAlt}
//   className="h-full min-h-[320px] w-full object-cover transition duration-700"
// />
...
//       <div className="absolute left-0 top-0 h-[400px] w-[400px] rounded-full bg-[#1597E5]/5 blur-[120px]" />
...
//             {/* KEEPING THE PROVIDED CONTENT */}
//             <div className="mt-7 space-y-6 text-base leading-8 text-slate-600">
...
//                 10 SMT lines aimed to serve prototype to high-mix volume for
...
//                 <div
//                   key={item}
//                   className="flex items-center gap-3 text-sm font-bold text-[#062D82]"
//                 >
//                   <CheckCircle2
//                     size={17}
//                     className="shrink-0 text-[#F4511E]"
//                   />
...
//               FORM
//           ====================================================== */}
//           <div className="border border-slate-200 bg-[#F8FAFC] p-7 shadow-[0_20px_60px_rgba(6,45,130,0.06)] sm:p-9 lg:p-10">
...
//                   <label
//                     htmlFor="message"
//                     className="text-sm font-bold text-[#062D82]"
//                   >
//                     Message
//                   </label>
...
//                 <label className="mb-2 block text-sm font-bold text-[#062D82]">
//                   Upload file
//                 </label>
...
//                   <div className="flex h-11 w-11 items-center justify-center rounded-full bg-[#062D82]/5">
//                     {fileName ? (
//                       <FileText
//                         size={21}
//                         className="text-[#062D82]"
//                       />
//                     ) : (
//                       <Upload
//                         size={21}
...
//                   {fileName ? (
//                     <span className="mt-3 text-sm font-bold text-[#062D82]">
//                       {fileName}
//                     </span>
//                   ) : (
//                     <>
...
//                       <span className="mt-1 text-sm font-bold text-[#1597E5]">
//                         Choose Files
//                       </span>
//                     </>
//                   )}
...
//                   font-black
//                   text-white
//                   shadow-[0_12px_30px_rgba(244,81,30,0.18)]
//                   transition
//                   duration-300
//                   hover:-translate-y-1
//                   hover:bg-[#062D82]
//                   hover:shadow-[0_15px_35px_rgba(6,45,130,0.2)]
//                 "
//               >
//                 SUBMIT
